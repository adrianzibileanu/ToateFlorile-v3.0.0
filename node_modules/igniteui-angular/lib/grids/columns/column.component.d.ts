...
export declare class IgxColumnComponent implements AfterContentInit, OnDestroy, ColumnType {
    ...
    constructor(grid: GridType, _validators: Validator[], cdr: ChangeDetectorRef, platform: PlatformUtil);
    /**
     * @hidden
     * @internal
     */
